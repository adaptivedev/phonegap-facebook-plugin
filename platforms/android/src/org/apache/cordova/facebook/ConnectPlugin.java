...
public class ConnectPlugin extends CordovaPlugin {
  ...
  private JSONObject m_jsonGetUserInfo;
      ...
      Request.newMeRequest(session, new Request.GraphUserCallback() {
        ...
        public void onCompleted(GraphUser user, Response response) {
          ...
          if (loginContext != null) {
            ...
            m_jsonGetUserInfo = graphObject.getInnerJSONObject();
            Log.d(TAG, "gab: return login object m_jsonGetUserInfo=" + m_jsonGetUserInfo.toString());
            userID = user.getId();
            //GAB: just return the graphObject - problem is then need to return same on iOS
            //loginContext.success(m_jsonGetUserInfo);
      ...
      public void onCompleted(Response response) {
        if (graphContext != null) {
          if (response.getError() != null) {
            ...
            GraphObject graphObject = response.getGraphObject();
            //GAB: inject additional user info we have to match iOS additions we added
            //JSONObject authResponseJson = graphObject.getInnerJSONObject().getJSONObject("authResponse");
            try {
              graphObject.getInnerJSONObject().put("authResponse", m_jsonGetUserInfo);
            } catch(JSONException e) {
              e.printStackTrace();
            }
